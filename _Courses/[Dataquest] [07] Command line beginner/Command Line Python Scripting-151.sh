...
/home/dq/python2/bin$ virtualenv -p /usr/bin/python3 python3

## 6. Activating a virtualenv ##

/home/dq/python2/bin$ source python3/bin/activate

## 7. Verifying the Installed Packages ##

(python3) /home/dq/python2/bin$ pip freeze

## 8. Importing Saved Functions into a File ##

(python3) /home/dq/python2/bin$ python script.py

## 9. Accessing Command Line Arguments ##

(python3) /home/dq/python2/bin$ python script "Hello from the command line"

## 10. Deactivating a virtualenv ##

(python3) /home/dq/python2/bin$ deactivate